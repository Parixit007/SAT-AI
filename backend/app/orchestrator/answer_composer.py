...
SYSTEM_PROMPT = (
    ...
    "description as a general impression rather than fact. If a detail in the description is implausible "
    "next to the measured land cover (for example tennis courts or storage tanks in a scene that is 98% "
    "farmland), leave that detail out or say it looks wrong -- do not repeat it as if it were likely.\n"
